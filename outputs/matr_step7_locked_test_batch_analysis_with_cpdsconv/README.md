...
- Models evaluated: ['persistence', 'cpmlp', 'cpdsconv', 'cpmlp_cpdsconv_fusion']
- Lookback cycles: 10
- Horizons: [10, 50, 100]
- Seeds: [42, 43, 44]
- Dataset batch filter: none (all batches loaded)
- Checkpoint roots, searched in order: ['outputs\\matr_step7_locked_test_cpdsconv_l10_h10_h50_h100_wide_best\\checkpoints', 'outputs\\matr_step7_locked_test_cpdsconv_only_l10_h10_h50_h100_fixedhp\\checkpoints']
